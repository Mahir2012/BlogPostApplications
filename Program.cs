...
class Program
{
    static void Main()
    {
        ...
        var blogType1 = new BlogType { Status = 1, Name = "Riyaz", Description = "Elder Brother" };
        var blogType2 = new BlogType { Status = 2, Name = "Aaftab", Description = "Cousin Brother" };
        ...
        var blog1 = new Blog { Url = "www.mahir.com", isPublic = true, BlogTypeId = blogType1.BlogTypeId, StatusId = status1.StatusId };
        var blog2 = new Blog { Url = "www.riyaz.com", isPublic = true, BlogTypeId = blogType2.BlogTypeId, StatusId = status2.StatusId };
        ...
        var user1 = new User { UserName = "Mahir", Email = "mahir20@gmail.com", PhoneNumber = "6758465733" };
        var user2 = new User { UserName = "Riyaz", Email = "riyaz20@gmail.com", PhoneNumber = "567876543" };
